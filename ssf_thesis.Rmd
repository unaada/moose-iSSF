...
# saveRDS(steps, "steps_data_fixed_with_burst.rds")
...
all_model_results[["season"]] <- run_stepwise_aic_selection(steps3, model_type = "season")

# Save the updated results
saveRDS(all_model_results, "saved_models/all_model_results_with_season.rds")
...
updated_model_tables <- recalculate_model_metrics(all_model_results)
...
for (model_name in names(updated_model_tables)) {
  ...
  # Save to CSV
  file_name <- paste0("updated_model_progression_", model_name, ".csv")
