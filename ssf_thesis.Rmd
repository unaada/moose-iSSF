...
steps3$slope <- scale(steps3$slope)
...
ggplot(steps3_original, aes(x = sl_)) +
  geom_histogram(alpha = 0.5) +
  labs(x = "Step length, m", y = "Count")

ggplot(steps3_original, aes(x = state_d)) +
  geom_histogram(alpha = 0.5) +
  labs(x = "Distance to state roads, m", y = "Count")

ggplot(steps3_original, aes(x = local_d)) +
  geom_histogram(alpha = 0.5) +
  labs(x = "Distance to local roads, m", y = "Count")
