...
steps3$l_sl_ <- scale(log(steps3$sl_))
steps3$cos_ta_ <- scale(cos(steps3$ta_))
steps3$l_minor_d <- scale(log(steps3$minor_d + 0.01))
steps3$l_major_d <- scale(log(steps3$major_d + 0.01))
steps3$l_local_d <- scale(sqrt(steps3$local_d + 0.01))
steps3$l_state_d <- scale(log(steps3$state_d + 0.01))
steps3$l_slope <- scale(log(steps3$slope))
