...
# [1] 261
# > sum(crossing_counts_local$Freq[crossing_counts_local$Time == "Night"])
# [1] 385
# > sum(crossing_counts_local$Freq[crossing_counts_local$Time == "Twilight"])
# [1] 110
# > sum(crossing_counts_state$Freq[crossing_counts_stateTime == "Twilight"])
# Error: object 'crossing_counts_stateTime' not found
# > sum(crossing_counts_state$Freq[crossing_counts_state$Time == "Twilight"])
# [1] 9
# > sum(crossing_counts_state$Freq[crossing_counts_state$Time == "Night"])
# [1] 30
# > sum(crossing_counts_state$Freq[crossing_counts_state$Time == "Day"])
# [1] 10
# > sum(crossing_counts_state$Freq[crossing_counts_state$Season == "Winter"])
# [1] 24
# > sum(crossing_counts_state$Freq[crossing_counts_state$Season == "Spring"])
# [1] 16
# > sum(crossing_counts_state$Freq[crossing_counts_state$Season == "Summer"])
# [1] 9
# > sum(crossing_counts_local$Freq[crossing_counts_local$Season == "Summer"])
# [1] 289
# > sum(crossing_counts_local$Freq[crossing_counts_local$Season == "Spring"])
# [1] 190
# > sum(crossing_counts_local$Freq[crossing_counts_local$Season == "Winter"])
...
ggplot(all_data, aes(x = category, y = mean, 
  ...
  scale_y_continuous(name = "Distance, m", limits = c(0, 2500)) +
  scale_color_manual(values = c("#C4A484", "#E6550D"),
